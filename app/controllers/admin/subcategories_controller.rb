class Admin::SubcategoriesController < AdminController
  ...
  def index
    @subcategories = Subcategory.all.paginate(page: params[:page]).order(name: :asc)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @subcategory.save
        ...
        format.json { render :show, status: :created, location: admin_subcategory_path(@subcategory) }
      else
  ...
  def update
    respond_to do |format|
      if @subcategory.update(subcategory_params)
        ...
        format.json { render :show, status: :ok, location: admin_subcategory_path(@subcategory) }
      else
